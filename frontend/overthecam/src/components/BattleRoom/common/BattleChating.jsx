...
const WebSocketChat = () => {
  ...
  return (
    <div className="w-full max-w-md h-full bg-cusGray rounded-lg mt-4 clay">
      {/* 채팅 헤더 */}
      <div className="flex justify-start px-4 py-1">
        <h2 className="py-1 text-lg font-semibold text-cusBlack-light">실시간 채팅</h2>
      </div>
      {/* 채팅 메시지 영역 - 스크롤바 커스텀 */}
      <div
        className="h-96 bg-white m-2 p-4 rounded-md overflow-y-auto [&::-webkit-scrollbar]:w-2 
        ...
        <div className="flex flex-col">
          ...
          <form onSubmit={sendMessage} className="flex">
            <input
              ...
              className="w-full h-full py-2 bg-white resize-none focus:outline-none border-none rounded-lg text-sm mr-1"
            />
            {/* 전송 버튼 */}
