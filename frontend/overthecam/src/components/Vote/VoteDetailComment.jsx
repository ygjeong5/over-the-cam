      ...
      <div className="clay bg-cusLightBlue-lighter rounded-lg shadow-lg p-6">
        ...
        <div className="space-y-4 mb-4 px-4">
          {comments.map((comment) => (
            <AnimatePresence key={comment.commentId}>
              <motion.div
              ...
              >
                ...
                {editingCommentId === comment.commentId ? (
                  ...
                  <motion.div
                    initial={{ scale: 0.8 }}
                    animate={{ scale: 1 }}
                    className="relative clay bg-white rounded-lg py-3 px-5 w-fit max-w-[80%] shadow-lg before:content-[''] before:absolute before:top-[-6px] before:left-[15px] before:w-3 before:h-3 before:bg-white before:rotate-45 before:rounded-sm before:shadow-lg"
                  >
