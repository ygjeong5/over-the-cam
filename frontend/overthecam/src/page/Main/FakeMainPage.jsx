...
const FakeMainPage = () => {
  ...
  useEffect(() => {
    ...
    const preloadImages = async () => {
      const images = [
        '../images/Desktop_mockup.webp',
        '../images/Desktop_mockup2.webp',
        '../images/Desktop_mockup3.webp'
      ];
      ...
      >
        ...
        <Section>
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <OptimizedImage
              src="../images/Desktop_mockup.webp"
              alt="논쟁 아이콘"
        ...
        <Section>
          <div className="flex flex-col md:flex-row items-center gap-8 -ml-8">
            <OptimizedImage
              src="../images/Desktop_mockup2.webp"
              alt="실시간 배틀"
        ...
        {/* 다섯 번째 섹션 - 스태거 효과 */}
        <Section backgroundImage="../images/Desktop_mockup3.webp">
          {/* 배경 이미지 첨부 */}
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
